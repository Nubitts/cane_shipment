...
$user_ = substr($header1->user_, 5, 2);
$pass_ = $header1->pass_;

$count = $db->executeStatement("select * from zones where cvezone = ? and password_ = ? and activate = 1", array($user_, $pass_));
...
if ($count > 0) {
  ...
  $Query = "select '0' as cvezone, '' as description, '' as hash_ ";
}
